...
public class DataStreamActivity extends FragmentActivity implements
		SensorEventListener {
		...
		toggleGyro.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (toggleGyro.isChecked()) {
					...
					mSensorManager.unregisterListener(DataStreamActivity.this,
							mSensorTypeGyro);
...
//		});
	...
	public void setCheckedFalse() {
		...
		mSensorManager.unregisterListener(DataStreamActivity.this, mSensorTypeAccel);

		mSensorManager.unregisterListener(DataStreamActivity.this, mSensorTypeGyro);
	}
