...
//			// this.datapoints[0] = (((0.0f - gMinValue) * (1.0f -
//			// (-1.0f))/(gMaxValue - gMinValue)) + (-1));
//			for (int i = 0; i < this.datapoints.length; i++) {
//				this.datapoints[i] = (((datapoints[i] - gMinValue)
//						* (1.0f - (-1.0f)) / (gMaxValue - gMinValue)) + (-1));
//				// Log.d("DD", "Data Chart" + this.datapoints[i]);
//			}
//			// this.datapoints[this.datapoints.length - 1] = (((0.0f -
//			// gMinValue) * (1.0f - (-1.0f))/(gMaxValue - gMinValue)) + (-1));
//			isUpdating = false;
//		} else {
//
//		}
